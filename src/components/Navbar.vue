        ...
        <div class="container">
            ...
            <div :class="['nav__modal', { 'nav__modal-open': isModalOpen }]">
                <ul class="nav__modal-list">
                    <li>
                        <router-link to="/avtomobillar" class="nav__modal-list-link"> <font-awesome-icon icon="car" />Avtomobillar </router-link>
                    </li>
                    <li>
                    ...
                    <li>
                        <router-link to="/smartfonlar" class="nav__modal-list-link"> <font-awesome-icon icon="mobile" />Smartfonlar</router-link>
                    </li>
                </ul>
            </div>
        </div>

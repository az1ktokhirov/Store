  ...
  <section class="cards">
    <div class="container">
      <div class="cards__content">
        <div v-if="beautyProducts.length === 0">No products found.</div>
        <div v-else v-for="product in beautyProducts" :key="product.id" class="cards__content-card">
...
const beautyProducts = computed(() => store.getters.getProductsByCategory('beauty'));

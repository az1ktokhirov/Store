  ...
  <section class="cards">
    <div class="container">
      <div class="cards__content">
        ...
        <div v-else v-for="product in filteredProducts" :key="product.id" class="cards__content-card">
...
const categories = ["womens-dresses", "womens-shoes", "womens-watches", "womens-bags", "womens-jewellery", "beauty"];
const filteredProducts = computed(() => {
  const allProducts = store.state.products;
  console.log('All products:', allProducts); 
  if (allProducts.length) {
    return allProducts.filter(product => categories.includes(product.category.toLowerCase()));
  }
  return [];
});
